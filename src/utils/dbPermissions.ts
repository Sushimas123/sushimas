...
const getDefaultPermissions = (userRole: string) => {
  ...
  if (userRole === 'super admin') {
    ...
    const allPages = ['ready', 'produksi', 'produksi_detail', 'gudang-final', 'analysis', 'product_settings', 'stock_opname_batch', 'esb', 'product_name', 'categories', 'recipes', 'supplier', 'branches', 'users', 'permissions-db', 'crud-permissions', 'audit-log', 'finance', 'aging-report', 'pettycash']
  ...
  if (userRole === 'admin') {
    const adminPages = ['ready', 'produksi', 'produksi_detail', 'gudang-final', 'analysis', 'product_settings', 'stock_opname_batch', 'esb', 'product_name', 'categories', 'recipes', 'supplier', 'branches', 'users', 'permissions-db', 'crud-permissions', 'audit-log', 'finance', 'aging-report', 'pettycash']
  ...
  if (userRole === 'finance') {
    const financePages = ['dashboard', 'ready', 'produksi', 'produksi_detail', 'gudang-final', 'analysis', 'stock_opname_batch', 'esb', 'users', 'product_settings', 'finance', 'aging-report', 'pettycash']
  ...
  if (userRole === 'pic_branch' || userRole === 'pic') {
    const picPages = ['dashboard', 'ready', 'produksi', 'produksi_detail', 'gudang-final', 'analysis', 'stock_opname_batch', 'esb', 'pettycash']
  ...
  if (userRole === 'staff') {
    const staffPages = ['dashboard', 'ready', 'produksi', 'gudang-final', 'stock_opname_batch', 'esb', 'pettycash']
...
export const canAccessPage = async (userRole: string, pagePath: string): Promise<boolean> => {
  ...
  try {
    ...
    const basicPages = ['ready', 'produksi', 'produksi_detail', 'gudang-final', 'analysis', 'esb', 'pettycash']
