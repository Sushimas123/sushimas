...
-- Update existing pic branch to pic_branch in crud_permissions
UPDATE crud_permissions SET role = 'pic_branch' WHERE role = 'pic branch';

-- Update existing pic branch to pic_branch in user_permissions  
UPDATE user_permissions SET role = 'pic_branch' WHERE role = 'pic branch';
